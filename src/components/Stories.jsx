            ...
            <div className='container mx-auto xl:max-w-[1218px] xl:px-3 px-6 md:my-[105px] my-[60px]'>
                <div className='flex flex-row flex-wrap justify-center relative xl:pt-[56px] lg:pt-[40px] pt-[20px]'>
                    <div className='md:w-1/2 flex flex-col md:items-end '>
                        ...
                        <div data-aos="fade-right" className='md:max-w-[350px] w-full rounded-[8px] bg-white shadow-[0px_10px_20px_0px_rgba(41,41,42,0.07)] cursor-pointer sm:pt-[40px] sm:px-[32px] md:pb-[96px] sm:pb-[32px] p-[16px] mt-[24px] hover:shadow-[0px_10px_18px_0px_rgba(41,41,42,0.20)] transition-shadow duration-300 ease-linear'>
                    ...
                    <div className='md:w-1/2 md:pl-[30px] md:mt-0 mt-[32px]'>
                        <div data-aos="fade-left" className='sm:pt-[39px] sm:pb-[14px] sm:px-[32px] p-[16px] rounded-[8px] cursor-pointer bg-white md:max-w-[445px] shadow-[0px_10px_20px_0px_rgba(41,41,42,0.07)] hover:shadow-[0px_10px_18px_0px_rgba(41,41,42,0.20)] transition-shadow duration-300 ease-linear'>
                        ...
                        <div data-aos="fade-up" className='md:max-w-[350px] rounded-[8px] sm:pt-[40px] sm:pb-[32px] sm:px-[32px] p-[16px] cursor-pointer shadow-[0px_10px_20px_0px_rgba(41,41,42,0.07)] hover:shadow-[0px_10px_18px_0px_rgba(41,41,42,0.20)] transition-shadow duration-300 ease-linear mt-[32px]'>
