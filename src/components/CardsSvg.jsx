        ...
        <>
            <div className='container mx-auto xl:max-w-[1308px] xl:px-3 px-6'>
                <div className='flex flex-row flex-wrap justify-between xl:pl-[40px] xl:pr-[50px]'>
                    <div data-aos="fade-down" className='xl:w-[21.7%] md:w-[46%] flex items-center justify-end flex-col'>
                        <Timer />
                    ...
                    <div data-aos="fade-down" className='xl:w-[21.7%] md:w-[46%] flex items-center justify-center flex-col xl:mt-0 mt-6'>
                        <Settings />
