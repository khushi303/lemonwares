          ...
          <div className='flex flex-row flex-wrap'>
            <div className='lg:w-1/2 w-full pt-[26px]'>
              ...
              <div className='flex sm:gap-[24px] gap-[16px]'>
                ...
                <button className='sm:py-[12px] sm:px-[17.5px] py-[10px] px-[14.3px] text-[14px] font-normal leading-[171.429%] hover:shadow-[2px_6px_12px_0px_rgba(0,0,0,0.30)] transition-shadow duration-300 ease-linear text-black rounded-[8px] bg-transparent border border-solid border-black'>Choose your plan</button>
              </div>
            </div>
        ...
        <div className={openTab === 4 ? "block" : "hidden"} id="link4">
          <div className='flex flex-row flex-wrap'>
            <div className='lg:w-1/2 w-full pt-[26px]'>
              ...
              <div className='flex sm:gap-[24px] gap-[16px]'>
                <button className='sm:py-[12px] sm:px-[13.5px] p-[10px] text-[14px] font-normal leading-[171.429%] text-white rounded-[8px] bg-[#B00000] border border-solid border-[#B00000] shadow-[0px_0px_64px_0px_rgba(176,0,0,0.30)] whitespace-nowrap hover:shadow-[2px_6px_12px_0px_rgba(176,0,0,0.30)] transition-shadow duration-300 ease-linear'>Create an Account</button>
                <button className='sm:py-[12px] sm:px-[17.5px] py-[10px] px-[14.3px] text-[14px] font-normal leading-[171.429%] hover:shadow-[2px_6px_12px_0px_rgba(0,0,0,0.15)] transition-shadow duration-300 ease-linear text-black rounded-[8px] bg-transparent border border-solid border-black'>Choose your plan</button>
              </div>
            </div>
            <div className='lg:w-1/2 w-full flex lg:justify-end lg:mt-0 mt-10'>
              <div className='relative max-w-[501px] sm:ml-[26px] sm:mr-[25px] mx-[10px]'>
