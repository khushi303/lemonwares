...
const GetStarted = () => {
    ...
    return (
        <>
            <div id='services' className='container mx-auto xl:max-w-[1121px] xl:px-3 px-6 lg:mt-[133px] sm:mt-[60px] mt-[40px]'>
                <div className='flex items-center justify-center flex-col'>
                    <h2 data-aos="fade-down" className='sm:text-[50px] text-[26px] font-semibold leading-[120%] text-black text-center max-w-[650px] lg:pb-[38px] pb-[25px]'>Ready to get started with
                        Lemon Wares?</h2>
                    ...
                    <div data-aos="fade-down" className='lg:mt-[57px] mt-[30px] flex items-center flex-wra p gap-2 lg:mb-[70px] mb-[32px]'>
                        <p className='sm:text-[25px] text-[16px] font-normal leading-[100%] text-black sm:pr-[31px]'>Monthly</p>
                        <div onClick={() => setToggle(!toggle)} className={`${toggle ? "bg-black" : "bg-[#B00000]"} sm:w-[93px] w-[60px] transition-colors duration-300 ease-linear cursor-pointer sm:h-[50px] h-[36px] rounded-[73px] px-[9px] py-[8px] sm:py-[10px]`}>
                            <div className={`${toggle ? "sm:translate-x-[144%] translate-x-[106%]" : "translate-x-0"} sm:w-[30px] w-[20px] h-[20px] transition-transform duration-300 ease-linear sm:h-[30px] rounded-[50%] bg-white`}></div>
                        </div>
                        <p className='sm:text-[25px] text-[16px] font-normal leading-[100%] text-black sm:pl-[26px]'>Yearly</p>
                        <button className='sm:px-[8px] sm:py-[7px] px-[6px] py-[5px] bg-[#FFE87A] rounded-[8px] text-[10px] font-semibold text-black leading-[90%] sm:ml-[17px]'>
                            20%  discount
                        </button>
                    </div>
                    ...
                    <div className='flex w-full flex-row flex-wrap sm:justify-between justify-center gap-[30p x]'>
                        <div data-aos="fade-right" className='xl:w-[28%] lg:w-[31%] sm:w-[48%] w-full  sm:block flex items-center justify-center'>
                            <div className='pl-[35px] pr-[27px] pt-[34px] pb-[48px] sm:max-w-[unset] max-w-[320px] group cursor-pointer border-[1.5px] border-solid border-[#C4C4C4] rounded-[15px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.15)_inset] hover:bg-[#c4c4c425] transition-all duration-300 ease-linear'>
                                ...
                                {show ? <button className='text-[14px] group-hover:bg-[#B00000] transition-colors group-hover:text-white whitespace-nowrap duration-300 ease-linear font-semibold leading-[228.571%] text-[#B00000] py-[9px] pl-[56px] pr-[60px] border-[2px] border-solid border-[#B00000] rounded-[12px]'>Choose this Plan</button> : <button className='text-[14px] group-hover:bg-black whitespace-nowrap transition-colors group-hover:text-white duration-300 ease-linear font-semibold leading-[228.571%] text-black py-[9px] pl-[56px] pr-[60px] border-[2px] border-solid border-black rounded-[12px]'>Choose this Plan</button>}
                        ...
                        <div data-aos="fade-up" className='xl:w-[28%] lg:w-[31%] sm:w-[48%] w-full sm:mt-0 mt-6 sm:block flex items-center justify-center'>
                            <div className=' pl-[35px] pr-[27px] pt-[34px] pb-[48px] border-[1.5px] cursor-pointer group sm:max-w-[unset] max-w-[320px] border-solid border-[#C4C4C4] rounded-[15px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.15)_inset] hover:bg-[#c4c4c425] transition-all duration-300 ease-linear'>
                                ...
                                {toggle ? <p className='text-[14px] font-light text-black leading-[100%] mt-[11px] mb-[35px]'>Per year</p> : <p className='text-[14px] font-light text-black leading-[100%] mt-[11px] mb-[35px]'>Per month</p>}
                                {show ? <button className='text-[14px] group-hover:bg-[#B00000] transition-colors whitespace-nowrap group-hover:text-white duration-300 ease-linear font-semibold leading-[228.571%] text-[#B00000] py-[9px] pl-[56px] pr-[60px] border-[2px] border-solid border-[#B00000] rounded-[12px]'>Choose this Plan</button> : <button className='text-[14px] group-hover:bg-black whitespace-nowrap transition-colors group-hover:text-white duration-300 ease-linear font-semibold leading-[228.571%] text-black py-[9px] pl-[56px] pr-[60px] border-[2px] border-solid border-black rounded-[12px]'>Choose this Plan</button>}
                                <div className='flex flex-col gap-[15px] mt-[35px]'>
                                    <div className='flex gap-[24px] items-center'>
                                        {show ? (<RedTick />) : (<Blacktick />)}
                                        <p className='text-[16px] ff_inter font-bold leading-[146%] text-[#808080]'>2GB SSD</p>
                        ...
                        <div data-aos="fade-left" className='xl:w-[28%] lg:w-[31%] sm:w-[48%] w-full lg:mx-[unset] sm:mx-auto lg:mt-0 mt-6 sm:block flex items-center justify-center'>
                            <div className=' pl-[35px] pr-[27px] pt-[34px] pb-[48px] border-[1.5px] group cursor-pointer sm:max-w-[unset] max-w-[320px] border-solid border-[#C4C4C4] rounded-[15px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.15)_inset] hover:bg-[#c4c4c425] transition-all duration-300 ease-linear'>
                                ...
                                {toggle ? <p className='text-[14px] font-light text-black leading-[100%] mt-[11px] mb-[35px]'>Per year</p> : <p className='text-[14px] font-light text-black leading-[100%] mt-[11px] mb-[35px]'>Per month</p>}
                                {show ? <button className='text-[14px] group-hover:bg-[#B00000] whitespace-nowrap transition-colors group-hover:text-white duration-300 ease-linear font-semibold leading-[228.571%] text-[#B00000] py-[9px] pl-[56px] pr-[60px] border-[2px] border-solid border-[#B00000] rounded-[12px]'>Choose this Plan</button> : <button className='text-[14px] group-hover:bg-black whitespace-nowrap transition-colors group-hover:text-white duration-300 ease-linear font-semibold leading-[228.571%] text-black py-[9px] pl-[56px] pr-[60px] border-[2px] border-solid border-black rounded-[12px]'>Choose this Plan</button>}
                                <div className='flex flex-col gap-[15px] mt-[35px]'>
                                    <div className='flex gap-[24px] items-center'>
                                        {show ? (<RedTick />) : (<Blacktick />)}
                                        <p className='text-[16px] ff_inter font-bold leading-[146%] text-[#808080]'>2GB SSD</p>
